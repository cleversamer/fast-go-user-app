...
export default function Trip({ trip, onPress }) {
  ...
  const styles = StyleSheet.create({
    ...
    arStatus: {
      paddingRight: screen.getHorizontalPixelSize(15),
      paddingLeft: screen.getHorizontalPixelSize(7),
      paddingVertical: screen.getVerticalPixelSize(3),
      position: "absolute",
      top: "5%",
      borderTopLeftRadius: screen.getHorizontalPixelSize(4),
      borderBottomLeftRadius: screen.getHorizontalPixelSize(4),
      color: "#fff",
    ...
    enStatus: {
      paddingLeft: screen.getHorizontalPixelSize(15),
      paddingRight: screen.getHorizontalPixelSize(7),
      paddingVertical: screen.getVerticalPixelSize(3),
      position: "absolute",
      top: "5%",
      borderTopRightRadius: screen.getHorizontalPixelSize(4),
      borderBottomRightRadius: screen.getHorizontalPixelSize(4),
      color: "#fff",
      backgroundColor: getStatusBadgeColor(),
      fontFamily: "cairo-700",
      fontSize: screen.getResponsiveFontSize(12),
  ...
  return (
    <TouchableOpacity style={getContainerStyles()} onPress={onPress}>
      ...
      <Text style={lang === "ar" ? styles.arStatus : styles.enStatus}>
        {i18n(`${trip.status}Trip`)}
      </Text>
    </TouchableOpacity>
  );
}
